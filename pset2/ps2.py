...
class RectangularRoom(object):
    ...
    def cleanTileAtPosition(self, pos):
        ...
        if not position in self.TilesCleaned:
            self.TilesCleaned.append(position)
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    for i in range(num_trials):
        ...
        coverage = cleanedTiles/totalTiles
        ...
        while coverage < min_coverage:
            ...
            time_steps += 1
        average_time += time_steps
        
        anim.done()
        
    return average_time/num_trials    

# Uncomment this line to see how much your simulation takes on average
# print(runSimulation(4, 2.0, 25, 25, 0.99, 30, StandardRobot))
...
#       (... your call here ...)
#
    showPlot1("StandardRobot vs RandomWalkRobot", "Time Step", "Average Time")
#
...
#       (... your call here ...)
#
    showPlot2("StandardRobot vs RandomWalkRobot", "Time Step", "Average Time")